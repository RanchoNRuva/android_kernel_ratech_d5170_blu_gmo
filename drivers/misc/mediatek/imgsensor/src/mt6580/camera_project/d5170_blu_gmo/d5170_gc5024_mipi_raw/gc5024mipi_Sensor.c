...
kal_bool SUBGC5024DuringTestPattern = KAL_FALSE;

static imgsensor_info_struct imgsensor_info = {
    .sensor_id = D5170_GC5024_SENSOR_ID,        //record sensor id defined in Kd_imgsensor.h

    .checksum_value = 0x596769eb,//0x647dd002,        //checksum value for Camera Auto Test
...
void gc5024_gcore_identify_otp(void)
{	
	write_cmos_sensor(0xfe, 0x00);				
	write_cmos_sensor(0xfe, 0x00);						  
	write_cmos_sensor(0xfe, 0x00);
...
static kal_uint32 open(void)
{
    ...
    spin_unlock(&imgsensor_drv_lock);
    SUBGC5024DuringTestPattern = KAL_FALSE; 
