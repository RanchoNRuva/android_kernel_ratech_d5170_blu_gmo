...
{0xB4,2,{0x00,0x73}},  //
//VGMP, VGSP, VGMN, VGSN
{0xB8,6,{0x00,0xB6,0x01,0x00,0xB6,0x01}},  //VGSN[7:0]	//
//GIP output voltage level.
{0xBA,3,{0x34,0x23,0x00}},  //
//SET RGB CYC
{0xC3,1,{0x02}},  //RGB_JDT[2:0] 2-dot
//SET TCON
{0xC4,2,{0x30,0x6A}},  //800 LINE
//POWER CTRL
{0xC7,9,{0x00,0x01,0x31,0x05,0x65,0x2C,0x13,0xA5,0xA5}},  //
//Gamma 
{0xC8,38,{0x79,0x5C,0x4F,0x3E,0x37,0x24,0x27,0x10,0x2B,0x2D,0x30,0x54,0x49,0x5A,0x54,0x5B,0x56,0x4D,0x41,0x79,0x5C,0x4F,0x3E,0x37,0x24,0x27,0x10,0x2B,0x2D,0x30,0x54,0x49,0x5A,0x54,0x5B,0x56,0x4D,0x41}},  //0x41
//CGOUTx_L GS=0
...
// ---------------------------------------------------------------------------
LCM_DRIVER jd9161_fwvga_hlt_cpt_d5170_lcm_drv = 
{
    .name			= "jd9161_fwvga_hlt_cpt_d5170",
