...
//JC
	...
	{0xA1,1,{0x16}}, // Gamma 251
	
	{0xA2,1,{0x26}},  // Gamma 247
	
	{0xA3,1,{0x13}},  // Gamma 239
	
	{0xA4,1,{0x0C}},  // Gamma 231
	
	{0xA5,1,{0x16}}, // Gamma 203
	
	{0xA6,1,{0x0A}},  // Gamma 175
	
	{0xA7,1,{0x08}},  // Gamma 147
	
	{0xA8,1,{0x05}},  // Gamma 108
	
	{0xA9,1,{0x08}},  // Gamma 80
	
	{0xAA,1,{0x0D}},  // Gamma 52
	...
	{0xC3,1,{0x13}},  // Gamma 16
	
	{0xC4,1,{0x0C}},  // Gamma 24
...
static void lcm_get_params(LCM_PARAMS * params)
{
    ...
    params->dsi.horizontal_frontporch 	= 90;//140;	
    ...
    params->dsi.PLL_CLOCK = 215;//dsi clock customization: should config clock value directly
...
{
	.name			= "ili9806e_dsi_vdo_fwvga_ivo_cw_tn",
